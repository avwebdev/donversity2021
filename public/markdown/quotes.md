...
<div class="row">
    <div class="col-sm" style="margin-bottom: 1.5em">
      <img src="/images/quotes/hubbard.png" alt="Quote from Mrs. Hubbard" style="display: inline: block; width: 100%">
    </div>
    <div class="col-sm" style="margin-bottom: 1.5em">
      <img src="/images/quotes/marek.png" alt="Quote from Mr. Marek" style="display: inline: block; width: 100%">
    </div>
</div>

<div class="row">
    <div class="col-sm" style="margin-bottom: 1.5em">
      <img src="/images/quotes/weber.png" alt="Quote from Mr. Weber" style="display: inline: block; width: 100%">
    </div>
    <div class="col-sm" style="margin-bottom: 1.5em">
      <img src="/images/quotes/anderson.png" alt="Quote from Mrs. Anderson" style="display: inline: block; width: 100%">
    </div>
</div>

<div class="row">
    <div class="col-sm" style="margin-bottom: 1.5em">
      <img src="/images/quotes/scavone.png" alt="Quote from Mrs. Scavone" style="display: inline: block; width: 100%">
    </div>
...
> I believe Donversity is about having a "voice" on our campus. We are a community who is trying to thrive in seeing, valuing, and supporting every individual who walks through our gates. Moving forward in 2021 I hope we embrace "Social distancing, does not mean social isolation." We see you Dons!!
> &nbsp; > **— Mrs. Scavone**
