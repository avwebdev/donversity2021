    ...
    <div id={styles.container} style={navbarStyles}>
      ...
      <div id={styles.expand} style={expandStyles}>
        <div id={styles.topRow}>
          ...
          <img
            className="dot"
            src="https://static.thenounproject.com/png/1616496-200.png"
            alt="dot"
          />
            ...
            <div className={styles.daybaby} style={xStyles}>
              ...
              <div>
                <a href="https://google.com">
                  A note from Green Team (world day 2020)
                </a>
              </div>
            </div>
          </div>
...
function changeImg() {
  return {
    content:
      'url("https://cdn.iconscout.com/icon/free/png-256/minus-146-475070.png")',
  };
}
...
function normalImg() {
  return {
    content:
      'url("https://cdn2.iconfinder.com/data/icons/ios-7-icons/50/plus-512.png")',
  };
}
